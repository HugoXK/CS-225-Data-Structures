...
int main()
{
    ...
    int pos, yes;
    int intitem, result1;
    AListrsort<int> mylist1;
    AListrsort<double> mylist2;
    ...
    switch(type)
    {
        case 0:
        {
            AListrsort<int> mylist1 = AListrsort<int>(size);
            break;
        }
        case 1:
        {
            AListrsort<double> mylist2 = AListrsort<double>(size);
            break;
        }
    }
    do
    {
        ...
        switch(op)
        {
            ...
            case 11:
            {
                ...
                startTime = clock();
                cout << "Enter a base value between 2 and 16:\n";
                srand(time(NULL));
                if (type == 0)
                {
                    cin >> intitem;
                    mylist1.radixsort(intitem);
                }
                else
                {
                    cin >> intitem;
                    mylist2.radixsort(intitem);
                }
                endTime = clock();
