...
int main()
{
    ...
    int pos, yes;
    int intitem, result1;
    AListsort<int> mylist1;
    AListsort<double> mylist2;
    ...
    switch(type)
    {
        case 0:
        {
            AListsort<int> mylist1 = AListsort<int>(size);
            break;
        }
        case 1:
        {
            AListsort<double> mylist2 = AListsort<double>(size);
            break;
        }
    }
    do
    {
        ...
        switch(op)
        {
            ...
            case 11:
            {
                ...
                startTime = clock();
                cout << "Enter a threshold value between 20 and 100:\n";
                srand(time(NULL));
                if (type == 0)
                {
                    cin >> intitem;
                    mylist1.qsort(intitem);
                }
                else
                {
                    cin >> intitem;
                    mylist2.qsort(intitem);
                }
                endTime = clock();
